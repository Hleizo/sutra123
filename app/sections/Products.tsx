...
type Item = {
  ...
  title: string;
  price: string;
  img: string;   // path in /public or remote URL
};

const items: Item[] = [
  { id: "1", title: "عباية كريب ناعمة", price: "35 JOD", img: "/abaya1.jpg" },
  { id: "2", title: "عباية عملية يومية", price: "29 JOD", img: "/abaya2.jpg" },
  { id: "3", title: "عباية رسمية أنيقة", price: "42 JOD", img: "/abaya3.jpg" },
  { id: "4", title: "عباية بلمسة ساتان", price: "39 JOD", img: "/abaya4.jpg" },
];
    ...
    <section className="max-w-5xl mx-auto px-4 py-12">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {items.map((p, i) => (
          ...
          >
            <div className="aspect-[4/5] bg-cream/60 overflow-hidden">
